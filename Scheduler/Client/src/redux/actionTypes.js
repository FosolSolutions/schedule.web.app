...
export const FETCH_OPENINGS_ERROR = "FETCH_OPENINGS_ERROR";
export const FETCH_OPENING = "FETCH_OPENING";
export const FETCH_OPENING_SUCCESS = "FETCH_OPENING_SUCCESS";
export const FETCH_OPENING_FAILURE = "FETCH_OPENING_FAILURE";
export const FETCH_OPENING_ERROR = "FETCH_OPENING_ERROR";
export const SET_ANSWER = "SET_ANSWER";
export const SET_CURRENT_OPENING_ID = "SET_CURRENT_OPENING_ID";
export const SET_CURRENT_QUESTION_ID = "SET_CURRENT_QUESTION_ID";

// -----------------------------------------------------------------------------
// UI action types
// -----------------------------------------------------------------------------
export const SET_CURRENT_CALENDAR_MONTH = "SET_CURRENT_CALENDAR_MONTH";
export const SET_DRAWER_IS_OPEN = "SET_DRAWER_IS_OPEN";
export const SET_MAIN_CONTENT_KEY = "SET_MAIN_CONTENT_KEY";
...
export const SIGN_OFF_ERROR = "SIGN_OFF_ERROR";
...
export const MANAGE_PARTICIPANT = "MANAGE_PARTICIPANT";
export const MANAGE_PARTICIPANT_ERROR = "MANAGE_PARTICIPANT_ERROR";
export const MANAGE_PARTICIPANT_FAILURE = "MANAGE_PARTICIPANT_FAILURE";
export const MANAGE_PARTICIPANT_SUCCESS = "MANAGE_PARTICIPANT_SUCCESS";
export const APPLY_TO_OPENING = "APPLY_TO_OPENING";
export const APPLY_TO_OPENING_ERROR = "APPLY_TO_OPENING_ERROR";
export const APPLY_TO_OPENING_FAILURE = "APPLY_TO_OPENING_FAILURE";
export const APPLY_TO_OPENING_SUCCESS = "APPLY_TO_OPENING_SUCCESS";
export const UNAPPLY_FROM_OPENING = "UNAPPLY_FROM_OPENING";
export const UNAPPLY_FROM_OPENING_ERROR = "UNAPPLY_FROM_OPENING_ERROR";
