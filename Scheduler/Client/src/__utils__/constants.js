...
export const SNACKBAR_DYNAMIC_CALENDARS_ERROR =
    "SNACKBAR_DYNAMIC_CALENDARS_ERROR";
export const SNACKBAR_DYNAMIC_ACTIVITIES_ERROR =
    "SNACKBAR_DYNAMIC_ACTIVITIES_ERROR";
export const SNACKBAR_DYNAMIC_OPENINGS_ERROR =
...
export const SVG_PATH_MICROSOFT =
    "M11.4 24H0V12.6h11.4V24zM24 24H12.6V12.6H24V24zM11.4 11.4H0V0h11.4v11.4zm12.6 0H12.6V0H24v11.4z";

// Hardcoded data values -------------------------------------------------------
// Schedule dates
export const DATE_START_ECCLESIAL_SCHEDULE = new Date(2020, 8, 1);
export const DATE_END_ECCLESIAL_SCHEDULE = new Date(2020, 11, 31);
